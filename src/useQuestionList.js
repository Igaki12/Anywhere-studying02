    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence: '脾臓/リンパ節を英語で',
          answerImg: [],
          answer: 'spleen / lymph node',
          commentary: '',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence: '胃腺を英語で',
          answerImg: [],
        ...
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence: '肝小葉を英語で',
          answerImg: [],
          answer: 'hepatic lobule',
          commentary: 'hepatic = liver',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence: '精巣上体管を英語で',
          answerImg: [],
          answer: 'Ductus epididymis',
          commentary: '',
        },
        {
          detailInfo: '',
          questionImg: [],
          questionSentence: '卵巣を英語で',
          answerImg: [],
          answer: 'ovary',
          commentary: '',
        },
    ...
    },
    {
      ...
      groupContents: [
        ...
        },
        {
          ...
          answer: ' 中脳腹側症候群　→Weber症候群（病気がみえるp41参考）',
          commentary:
        ...
        },
        {
          ...
          answer: '左内側毛帯',
          commentary:
            '後索-内側毛帯路を通り、内側毛帯のすぐ下側で交叉し、内側毛帯でニューロンを変える。',
          choices: [
            '右楔状束核',
            '左前脊髄視床路',
            '右内側毛帯',
        ...
        },
        {
          ...
          answer: '左外転神経',
          commentary:
            '外転神経は外直筋、滑車神経は上斜筋、動眼神経はそれ以外の外眼筋を支配する。',
        ...
        },
        {
          ...
          answer: '左顔面神経',
          commentary:
            '表情筋は顔面神経支配、咀嚼筋は三叉神経支配、咽頭の筋肉は迷走神経支配。',
          choices: [
            '左三叉神経',
            '右三叉神経',
            '左顔面神経',
