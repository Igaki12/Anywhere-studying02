      ...
      groupContents: [
        {
          ...
          choices: ['糸球体毛細血管', '毛細血管後細静脈', '肺胞毛細血管', '中心静脈',],
          answerImg: [],
          answer: '',
          commentary: '',
        },
        ...
        },
        {
          ...
          choices: ['層板小体', '管状クリステ', '脂肪滴', 'アクチンフィラメント'],
          answerImg: [alveolus],
          answer: '',
          commentary: '',
        },
        ...
        },
        {
          ...
          choices: ['メサンギウム細胞', 'ピット細胞', '内皮細胞', 'セルトリ細胞'],
          answerImg: [],
          answer: '',
          commentary: '',
        },
        {
          ...
          choices: ['伊東細胞', 'クッパー細胞', 'ピット細胞', 'ランゲルハンス細胞', ''],
          answerImg: [liver],
          answer: '',
          commentary: '',
        },
        ...
        },
        {
          ...
          choices: ['クッパー細胞', 'ピット細胞', '伊東細胞', 'メサンギウム細胞',],
          answerImg: [liver],
          answer: '',
          commentary: '',
        },
        ...
        },
        {
          ...
          answerImg: [renalTubule],
          answer: '',
          commentary: '集合管collecting ductの上皮は冊子縁がなく、また細胞が立法状であるため細胞境界が明確',
        },
        {
          detailInfo: '(36)',
          questionImg: [],
          questionSentence: '.血管尿関門を構成しない細胞',
          choices: ['ボウマン嚢壁細胞', 'たこ足細胞', '基底膜', '糸球体内皮細胞',],
        ...
        },
        {
          ...
          choices: ['ハッサル小体', 'ランゲルハンス島', 'ニッスル小体', 'ライディッヒ細胞', ''],
          answerImg: [],
          answer: '',
          commentary: '',
        },
        {
          ...
          choices: ['クロム親和性細胞', 'クッパー細胞', 'ニッスル小体', 'ライディッヒ細胞', ''],
          answerImg: [],
          answer: '',
          commentary: 'クロム親和性細胞は交感神経節後ニューロンに相当する細胞である。',
        },
        {
          detailInfo: '(47)',
          questionImg: [],
        ...
        },
        {
          ...
          choices: ['杯細胞', 'クッパー細胞', 'パネート細胞', 'メサンギウム細胞',],
          answerImg: [],
          answer: '',
          commentary: '',
        },
        ...
        },
        {
          ...
          choices: ['クロマチン', '層板小体', '管状クリステ', 'アクチンフィラメント',],
          answerImg: [],
          answer: '',
          commentary: '',
        },
