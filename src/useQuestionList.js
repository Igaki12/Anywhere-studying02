      ...
      groupContents: [
        {
          ...
          commentary:
            '異常は3つに分類される（右半身片麻痺・右半身の感覚麻痺・舌の運動障害）。それぞれ舌の左側に運動障害がみられるので延髄付近の中枢神経に異常があると推測できる（延髄より上だと舌の右側、下だと舌に障害がみられない）。Wallenberg症候群（延髄外側の障害）でみられる温痛覚障害・Horner症候群などが生じていないことから、これ以外の延髄内側の部分で障害が起こっていると推測できる。脳底動脈の傍正中枝の閉塞が原因',
        },
        {
          detailInfo: '症例2',
          questionImg: [],
        ...
        },
        {
          ...
          answerImg: [attendance1, centralMotorNeuron],
